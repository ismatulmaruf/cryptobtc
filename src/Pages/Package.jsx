  ...
  return (
    <Layout>
      <div
        ...
        style={{
          backgroundImage: `url('https://i.imgur.com/obnItkh.jpeg')`,
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl flex flex-col items-center space-y-8">
          {/* Point Display */}
          <div className="flex flex-col md:flex-row items-center justify-center  p-6 rounded-lg shadow-lg text-center w-full">
          ...
          <div className="bg-[#1F2937] p-6 md:p-8 rounded-xl border-4 border-[#00D084] shadow-lg dark:shadow-xl text-center w-full">
            <h2 className="text-2xl md:text-3xl text-yellow-400 font-bold mb-4">
              Deposit Instructions (USDT Deposit Package)
            </h2>
            <p className="text-white text-sm md:text-lg mb-4">
              Please send the USDT to the following address before submitting
              the form. Use the USDT Deposit Package for this transaction.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                >
                  ...
                  <option value="12">12 USDT</option>
