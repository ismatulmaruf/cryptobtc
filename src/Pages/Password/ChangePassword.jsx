    ...
    <Layout>
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh] dark:bg-gray-900">
        <form
          ...
          autoComplete="off"
          noValidate
          className="flex flex-col bg-[#0A1018] border border-2 border-[#00D084] gap-4 rounded-lg md:py-5 py-7 md:px-7 px-3 md:w-[500px] w-full shadow-custom dark:shadow-xl  "
        >
          <h1 className="text-center text-[#00D084] text-4xl font-bold font-inter">
